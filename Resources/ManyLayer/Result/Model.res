...
lifetime=s:rebuild
result=s:1
treepath=s:1D Results\Power\Excitation [pw]\Loss per Material\Metal loss in Copper (pure)
files=s:cMetal_loss_Copper (pure)(pw).sig
...
lifetime=s:rebuild
result=s:1
treepath=s:1D Results\Power\Excitation [pw]\Loss per Material\Metal loss in Nickel
files=s:cMetal_loss_Nickel(pw).sig
...
lifetime=s:rebuild
result=s:1
treepath=s:1D Results\Power\Excitation [pw]\Loss in Metals
files=s:cTotal_metal_loss(pw).sig
...
lifetime=s:rebuild
result=s:1
treepath=s:1D Results\Power\Excitation [pw]\Loss per Material\Volume loss in Polyimide (lossy)
files=s:cVolume_loss_in_Polyimide (lossy)(pw).sig
